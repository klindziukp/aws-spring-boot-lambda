...
PAYMENTS_TABLE_DYNAMODB_STREAM_ARN=$(awslocal dynamodb describe-table --table-name payments | jq -r '.Table.LatestStreamArn')
echo "PAYMENTS_TABLE_DYNAMODB_STREAM_ARN=${PAYMENTS_TABLE_DYNAMODB_STREAM_ARN}"
